...
MODEL_PATH = "./resnet50_best_team2_recycle"
NUM_CLASSES = 13  # 클래스 개수 (사용자가 설정한 클래스 수)
...
class_labels = ["영업용_냉장고", "컴퓨터_cpu", "드럼_세탁기", "냉장고", "컴퓨터_그래픽카드",
...
def index():
    return """
    <h1>flask server Team2 Recycle Appliance Classification</h1>
